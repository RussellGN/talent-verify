...
def endpoints(request):
   api_endpoints = [
      ...
      }, 
      {
         ...
         "accepts" : "a query object used to filter the employees retrieved (JSON)",
      ...
      }, 
      {
         ...
         "accepts" : "an auth token and a list of one or more employees for adding to an employers list of employees (JSON)",
      ...
      }, 
      {
         ...
         "accepts" : "an auth token and a list of one or more employees's partial/complete details for updating (JSON)",
